...
class ProfileService {
  ...
  Future<void> updateDriverCompany(String driverId, String companyId, String companyName) async {
    try {
      final docRef = getProfileDocRef(driverId, 'driver');
      await docRef.update({
        'companyId': companyId,
      ...
      print('Error updating driver company: $e');
      rethrow;
    }
  }
