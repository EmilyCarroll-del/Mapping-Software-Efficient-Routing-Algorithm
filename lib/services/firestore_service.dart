...
class FirestoreService {
  ...
  Stream<List<Map<String, dynamic>>> getAvailableDriversForAdmin(
  ...
  Future<List<Map<String, dynamic>>> getDriversByCompanyCode(
    ...
    try {
      ...
      final freelanceDrivers = allDrivers.docs.where((doc) {
        final data = doc.data();
  ...
  Stream<List<Map<String, dynamic>>> getAvailableAdminsForDriver(
      String? driverCompanyCode) {
  ...
  bool canDriverWorkWithAdmin(
      String? driverCompanyCode, String adminCompanyCode) {
    if (driverCompanyCode == null || driverCompanyCode.isEmpty) {
