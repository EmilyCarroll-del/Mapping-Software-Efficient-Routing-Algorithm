// lib/.../add_edit_address_dialog.dart  (use your real path)
import 'dart:convert';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Note: The API key is handled by the server, not the client
              if (kIsWeb) ...[
                AddressAutocompleteField(
                  apiKey: '', // Not used - server handles the API key
                  countryCode: null, // null = search globally (like Google Maps), or use 'us' to restrict to US
                  onSelected: (place) {
                    debugPrint('Place selected: ${place.formattedAddress}');
                    debugPrint('Address components: ${place.addressComponents}');
                    _addressController.text = place.formattedAddress;
                    _selectedPlaceDetail = place; // Store the place details
                    setState(() {});
                  },
                ),
