...
class AddressAutocompleteField extends StatefulWidget {
  final String apiKey;                 // <<— use the Web key here
          ...
          TypeAheadField<AddressSuggestion>(
            ...
            builder: (context, controller, focusNode) {
              return TextField(
                ...
                focusNode: focusNode,
                // 1. Change to generic text to stop browser from thinking "Address!"
                keyboardType: TextInputType.text,
                // 2. Explicitly disable browser autofill hints
                autofillHints: const [],
                // 3. Disable soft keyboard suggestions
            ...
            onSelected: (s) async {
              ...
              if (detail != null) {
                ...
                // Clear any remaining suggestions by resetting the controller
